    ...
    Component {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                color: parent.occupied ? Color.colors[Config.options.bar.foreground] : Color.colors[Config.options.bar.background]
                implicitWidth: active ? Variable.uiScale(16) : Variable.uiScale(8)
                implicitHeight: active ? Variable.uiScale(16) : Variable.uiScale(8)
                border.color: Color.colors[Config.options.bar.foreground]
                rotation: active ? 45 : 0
